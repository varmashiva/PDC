            ...
            <div className="w-full max-w-[420px] bg-[#0a0a0a] border border-white/5 p-10 md:p-12 rounded-[2.5rem] shadow-2xl relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <input 
                            type="email" 
                            className="w-full bg-white/[0.02] border border-white/5 p-4 rounded-xl text-sm font-bold outline-none focus:border-[#ff1a1a]/50 focus:bg-white/[0.05] transition-all text-white placeholder:text-white/10"
                    ...
                    <button type="submit" className="w-full mt-8 bg-white text-black py-4 rounded-xl text-[0.65rem] font-black uppercase tracking-[0.2em] hover:bg-[#ff1a1a] hover:text-white hover:-translate-y-1 transition-all shadow-xl hover:shadow-[0_10px_40px_rgba(255,26,26,0.3)] duration-300 flex items-center justify-center gap-2 group">
                        Initiate Login
                ...
                <p className="text-center text-[0.65rem] font-bold uppercase tracking-widest text-white/30 mt-10">
                    New to the studio? <Link to="/register" className="text-[#ff1a1a] hover:text-white transition-colors">Apply here</Link>
                </p>
            </div>
